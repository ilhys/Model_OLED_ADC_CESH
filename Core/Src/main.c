...
int main(void)
{
  ...
  HAL_TIM_Base_Start_IT(&htim1); //?1?7?1?7?1?7?1?7?1?7?1?7?0?2?1?7?1?7?1?7§Ø?1?7
  HAL_ADCEx_Calibration_Start(&hadc1);                  //AD§µ?0?6
  HAL_ADC_Start_DMA(&hadc1, (uint32_t*)&ADC_Value, ADC_SIZE);
  HAL_TIM_Base_Start_IT(&htim3); //?1?7?1?7?1?7?1?7?1?7?1?7?0?2?1?7?1?7?1?7§Ø?1?7
  ceshi=156.0212;
  ...
  /**********************?1?7?1?7?1?7§Ú?1?7?1?7?1?7?0?0?1?7ÈÎ*******************************/
  AdcConvEnd=0;  
  ...
  /**********************?1?7?1?7?1?7?1?7?1?7ÈÎ?1?7?1?7?1?7*******************************/
  fft_outputbuf[0] /= 1024;

    for (int i = 1; i < FFT_LENGTH; i++)//?1?7?1?7?1?7?1?7?1?7?1?7?1?7§Ô?1?7?1?7?1?7?1?7?0?5
    {
        fft_outputbuf[i] /= 512;
    }
    ...
    for (int i = 0; i < FFT_LENGTH; i++)//?1?7?1?7?1?7?1?7?1?7?1?7?1?7§Ô?1?7?1?7?1?7?1?7?0?5
    {
        printf("%d:\t%.2f\r\n", i, fft_outputbuf[i]);
    }    
